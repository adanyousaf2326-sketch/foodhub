...
<div class="admin-main container"><div class="card">
    ...
    <form method="POST" action="{{ isset($announcement) ? route('admin.announcements.update', $announcement) : route('admin.announcements.store') }}">
        ...
        <div class="field"><label>Deal Poster / Image URL</label><input type="url" name="deal_image" value="{{ old('deal_image', $announcement->deal_image ?? '') }}" placeholder="https://example.com/deal-poster.jpg"><small>This image will be shown to customers on the deal popup.</small></div>
