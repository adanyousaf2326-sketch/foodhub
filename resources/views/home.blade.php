...
@media (max-width: 600px) {
    ...
    /* ── DARK THEME (inside blade, highest priority) ── */
    ...
    body.dark-theme strong, body.dark-theme label { color: #f1f5f9 !important; }
    body.dark-theme p, body.dark-theme small { color: #94a3b8 !important; }
    body.dark-theme a { color: #60a5fa !important; }
    body.dark-theme nav { background: #0f172a !important; }
    body.dark-theme .hero { background: linear-gradient(90deg, rgba(15,23,42,.95), rgba(15,23,42,.6)) !important; }
    body.dark-theme .hero h1 { color: #f1f5f9 !important; }
    body.dark-theme .hero p { color: #94a3b8 !important; }
    body.dark-theme .section-title h2 { color: #f1f5f9 !important; }
    body.dark-theme .section-title p { color: #94a3b8 !important; }
    body.dark-theme .category { background: #1e293b !important; color: #e2e8f0 !important; border: 1px solid #334155 !important; }
    body.dark-theme .category h3 { color: #f1f5f9 !important; }
    body.dark-theme .category p { color: #94a3b8 !important; }
    body.dark-theme .food-card { background: #1e293b !important; border: 1px solid #334155 !important; }
    body.dark-theme .food-info h3 { color: #f1f5f9 !important; }
    body.dark-theme .food-info p { color: #94a3b8 !important; }
    body.dark-theme .food-bottom { border-top: 1px solid #334155 !important; }
    body.dark-theme .price { color: #f1f5f9 !important; }
    body.dark-theme .price-old { color: #64748b !important; }
    body.dark-theme .food-category { background: rgba(255,107,0,.15) !important; color: #ff8c38 !important; }
    body.dark-theme .menu-top { color: #94a3b8 !important; }
    body.dark-theme .all-food-btn { background: #334155 !important; color: #e2e8f0 !important; }
    body.dark-theme .selected-category { color: #ff6b00 !important; }
    body.dark-theme .menu-poster { background: #1e293b !important; border-color: #334155 !important; }
    body.dark-theme .poster-header { background: #0f172a !important; }
    body.dark-theme .poster-header h2 { color: #f1f5f9 !important; }
    body.dark-theme .poster-header p { color: #94a3b8 !important; }
    body.dark-theme .poster-logo { color: #f1f5f9 !important; }
    body.dark-theme .poster-subtitle { color: #94a3b8 !important; }
    body.dark-theme .poster-category-title { color: #f1f5f9 !important; border-bottom-color: #ff6b00 !important; }
    body.dark-theme .poster-item { border-bottom-color: #334155 !important; }
    body.dark-theme .poster-item-left strong { color: #e2e8f0 !important; }
    body.dark-theme .poster-item-left small { color: #94a3b8 !important; }
    body.dark-theme .poster-price { color: #ff6b00 !important; }
    body.dark-theme .poster-old-price { color: #64748b !important; }
    body.dark-theme .poster-deal { background: rgba(22,101,52,.1) !important; border-color: rgba(22,101,52,.4) !important; }
    body.dark-theme .poster-deal-info h3 { color: #4ade80 !important; }
    body.dark-theme .poster-deal-info strong { color: #e2e8f0 !important; }
    body.dark-theme .poster-deal-info p { color: #94a3b8 !important; }
    body.dark-theme .poster-deal-item { background: rgba(22,101,52,.2) !important; color: #4ade80 !important; }
    body.dark-theme .poster-footer { background: #0f172a !important; color: #94a3b8 !important; }
    body.dark-theme .side-cart { background: #1e293b !important; border-color: #334155 !important; }
    body.dark-theme .cart-header { background: #0f172a !important; }
    body.dark-theme .cart-header h3 { color: #f1f5f9 !important; }
    body.dark-theme .side-cart-info h4 { color: #f1f5f9 !important; }
    body.dark-theme .side-cart-info p { color: #94a3b8 !important; }
    body.dark-theme .qty-number { color: #e2e8f0 !important; }
    body.dark-theme .cart-footer { background: #1e293b !important; border-top-color: #334155 !important; }
    body.dark-theme .cart-total-row { color: #e2e8f0 !important; }
    body.dark-theme .continue-btn { background: #334155 !important; color: #e2e8f0 !important; }
    body.dark-theme .announcement-overlay { background: rgba(0,0,0,.75) !important; }
    body.dark-theme .announcement-panel { background: #1e293b !important; }
    body.dark-theme .announcement-panel h2 { color: #f1f5f9 !important; }
    body.dark-theme .announcement-kicker { color: #4ade80 !important; }
    body.dark-theme .announcement-message { color: #94a3b8 !important; }
    body.dark-theme .announcement-food { background: #0f172a !important; border-color: #334155 !important; color: #e2e8f0 !important; }
    body.dark-theme .announcement-close { background: #334155 !important; color: #e2e8f0 !important; }
    body.dark-theme .bundle-total { color: #4ade80 !important; }
    body.dark-theme .toast { background: #334155 !important; color: #e2e8f0 !important; }
    body.dark-theme footer { background: #0f172a !important; color: #94a3b8 !important; }
    body.dark-theme .menu-deal-card { background: rgba(22,101,52,.15) !important; border-color: rgba(22,101,52,.4) !important; }
    body.dark-theme .menu-deal-info h3 { color: #4ade80 !important; }
    body.dark-theme .menu-deal-info p { color: #94a3b8 !important; }
    body.dark-theme .deal-badge { background: rgba(22,101,52,.2) !important; color: #4ade80 !important; }
    body.dark-theme .discount-badge { background: rgba(220,38,38,.15) !important; color: #f87171 !important; }
    body.dark-theme .order-btn { background: #ff6b00 !important; color: white !important; }
    body.dark-theme .empty { color: #94a3b8 !important; }
    body.dark-theme .empty h3 { color: #f1f5f9 !important; }
    body.dark-theme .track-card { background: #1e293b !important; border-color: #334155 !important; }
    ...
    body.dark-theme .full-menu-section { background: rgba(0,0,0,.8) !important; }
    body.dark-theme .theme-toggle-customer { background: rgba(255,200,60,.15) !important; border-color: rgba(255,200,60,.3) !important; }
